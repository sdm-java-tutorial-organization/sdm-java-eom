...
@Deprecated
public enum MultipleParentColumnOld implements OldExcelColumn {

    GROUP(0, "group", String.class),
    HERO(1, "excelColumnHero", MultipleChildColumnOld.class);

    // force field
    MultipleParentColumnOld(int order, String field, Class<?> type) {
        this.order = order;
        this.field = field;
        this.type = type;
    }
